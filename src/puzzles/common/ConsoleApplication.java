...
public abstract class ConsoleApplication {
    ...
    protected void help( String[] args ) {
        this.out.println("h(int)              -- hint next move");
        this.out.println("l(oad) filename     -- load new puzzle file");
        this.out.println("s(elect) r c        -- select cell at r, c");
        this.out.println("q(uit)              -- quit the game");
        this.out.println("r(eset)             -- reset the current game");
        this.out.println();
    }
